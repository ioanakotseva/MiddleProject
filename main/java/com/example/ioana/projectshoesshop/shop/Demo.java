...
public class Demo {
	...
	public static void main(String[] args) {
		...
		Product kec = new WomanShoes.SportWoman("Kec", "black", "Udobni za tichane!", 24.5, 38);
		Product official = new WomanShoes.FormalWoman("Qna", "black&red",  "Visok tok!", 52, 38, 12.4);
		Product balerina = new WomanShoes.DailyWoman("Balerinka", "red", "Podhodqshti za vseki den!", 32, 38);
		Product maratonka = new ManShoes.SportMan("Nike Air", "blue&white", "Za tichane1!", 105, 43, true);
		Product skin = new ManShoes.FormalMan("Skin Shoes", "brown", "Za oficialen sl!", 87.5, 43, false);
		Product cubinka = new ManShoes.DailyMan("Kubinka", "yellow",  "Tejki i plytni!", 54, 43);
